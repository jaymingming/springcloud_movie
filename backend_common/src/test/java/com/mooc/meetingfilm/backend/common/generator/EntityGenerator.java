...
public class EntityGenerator {
    ...
    private String outputDir = "I:\\java_project\\springcloud\\springcloud_maoyan_code_repository\\backend_common\\src\\main\\java";
    // 生成类的作者
    private String author = "xiaoming";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.mooc.meetingfilm.backend.common";
    // 待生成的表名，注意是覆盖更新
