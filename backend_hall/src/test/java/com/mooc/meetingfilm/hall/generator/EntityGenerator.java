package com.mooc.meetingfilm.hall.generator;
...
public class EntityGenerator {
    ...
    private String outputDir = "I:\\java_project\\springcloud\\back_parent\\backend_hall\\src\\main\\java";
    // 生成类的作者
    private String author = "java练习生";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.mooc.meetingfilm.hall.dao";
    // 待生成的表名，注意是覆盖更新
    private static String[] tableNames;

    static{
        tableNames = new String[]{
                "mooc_hall_film_info_t","mooc_field_t"
        };
    }
